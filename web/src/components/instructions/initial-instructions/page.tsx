...
export default function InstructionsScreen({
  ...
  return (
    <div className="flex min-h-screen flex-col p-4 justify-center text-gray-800 sm:p-6 md:p-8">
      <div className="w-full max-w-2xl mx-auto pb-8 sm:pb-12 md:pb-16">
      ...
      {/* Footer Buttons */}
      <div className="w-full max-w-2xl mx-auto mt-2 sm:mt-3">
        <div className="space-y-2 sm:space-y-4">
          <Button
            onClick={onContinue}
            className="w-full  font-bold py-6 px-4 rounded-xl transition-colors duration-300 text-base sm:text-lg"
          >
            Continuar
          </Button>
        </div>
