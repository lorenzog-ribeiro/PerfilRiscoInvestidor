...
export default function Etapa2({ scenario, onConclude }: any) {
        ...
        <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center md:px-1">
            <div className="w-full max-w-5xl space-y-6 flex flex-col items-center justify-center">
                <h1 className="text-2xl font-semibold text-center text-gray-900">
                    Você prefere não ganhar/perder nada ou arriscar?
                </h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 gap-2">
                    ...
                    >
                        <CardContent className="p-2 space-y-2">
                            ...
                            <h2 className="text-lg font-semibold text-gray-800 text-center">Sem ganho ou perda</h2>
                    ...
                    >
                        <CardContent className="p-2 space-y-2">
                            ...
                            <h2 className="text-lg font-semibold text-gray-800 text-center">Ganho ou perda incertos</h2>
